...
extern "C"
{
	void LP_FLEXCOMM2_IRQHandler( void ) { if ( s_instances[2] ) s_instances[2]->_irq_handler(); SDK_ISR_EXIT_BARRIER; }
...
extern "C"
{
    void LPUART0_IRQHandler( void ) { if ( s_instances[0] ) s_instances[0]->_irq_handler(); }
    void LPUART1_IRQHandler( void ) { if ( s_instances[1] ) s_instances[1]->_irq_handler(); }
}
...
//   MB_TX = D18 = PTE0  -> LPUART1_TX  Alt3
//   MB_RX = D19 = PTE1  -> LPUART1_RX  Alt3
//   D1    = PTA2        -> LPUART0_TX  Alt2  (= debug UART / USBTX)
//   D0    = PTA1        -> LPUART0_RX  Alt2  (= debug UART / USBRX)
static const lpuart_pin_map_t s_pinMap[] = {
...
#else
#  error "Serial.cpp: unsupported target. Define CPU_MCXA153VLH, CPU_MCXN236VDF, or CPU_MCXC444VLH."
